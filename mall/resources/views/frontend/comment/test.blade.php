                    ...
                    <div class="panel-heading">评价商品</div>
                        <div class="panel-body">
                            <div class="alert alert-success">
                                ...
                                {{csrf_field()}}
                                <input type="number" name="comment_id" value="comment_id">
                            ...
                            @foreach ($list as $row)
                             {{--获取原图--}}
                            <img src="{{ $row[0]['key'] }}" width="100">

                            {{--/*--}}
                            {{--*   获取大小压缩的图片--}}
                            {{--*   加参数：?imageView/1/w/图片宽度/h/图片高度 ，可以只传宽度或者高度数据--}}
                            {{--*/--}}
                            {{--<img src="{{ Config::get('filesystems.disks.qiniu.domain'). '/'.$row[0]['key'] }}?imageView/1/w/200/h/100">--}}

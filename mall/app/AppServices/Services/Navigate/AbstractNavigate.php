...
{
    public static $navigateRepository;

    final function __construct(App $app)
    {
        if (empty(static::$navigateRepository)) {
            static::$navigateRepository = $app->make('App\AppServices\Repositories\Navigate\NavigateRepository');
        }
